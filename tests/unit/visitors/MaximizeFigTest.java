...
public class MaximizeFigTest {
    ...
    public void testVisitRectangle() {
        assertEquals("New Height: 4.0 | New Widht: 4.0", maximizeFig.visit(rect));
    }

    @Test
    public void testVisitCircle() {

        assertEquals("New Radius: 10.0", maximizeFig.visit(circle));
        // assertNotEquals(52.0, 10.0, 1000);
    }

    @Test
    public void testVisitTriangle() {
        assertEquals("New Side A: 6.0 | New Side B: 8.0 | New Side C: 10.0", maximizeFig.visit(triangle));
        // assertNotEquals(52.0, 10.0, 1000);
    }
    ...
    public void testVisitTrapezoid() {
        ...
        assertEquals("New Larger Base: 52.0 | New Smaller Base: 32.0 | New Side A: 26.0 | New Side B: 26.0",
                maximizeFig.visit(trapezoid));
        // assertNotEquals(52.0, 10.0, 1000);
    }
